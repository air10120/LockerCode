...
| 截图 | 说明 |
| --- | --- |
| ![扫描界面 1](docs/screenshots/scan_1.jpg) | 输入多个取件码后打开相机实时扫描，命中包裹高亮标记为「已找到」 |
| ![扫描界面 2](docs/screenshots/scan_2.jpg) | 继续扫描货架其他区域，多个包裹持续命中并实时更新状态 |

### 设置界面

| 截图 | 说明 |
| --- | --- |
| ![设置界面 1](docs/screenshots/settings_1.jpg) | 跳帧间隔、分析分辨率、命中震动、标签文字、字符容错等识别参数 |
| ![设置界面 2](docs/screenshots/settings_2.jpg) | 标签文字颜色、识别框颜色及线宽、更新日志、关于 App 信息 |
